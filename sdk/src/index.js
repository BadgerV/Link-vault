...
exports.createVault = exports.getWallet = void 0;
...
var vaultUrl = 'https://linkvault.com.ng/?#';
...
var getPublicKey = function (priv) {
    var privateKeyString = Buffer.from(priv).toString('hex');
...
var createVault = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        try {
            ...
            privateKeyString = Buffer.from(privateKey).toString('hex');
...
var getWallet = function (linkvault) { return __awaiter(void 0, void 0, void 0, function () {
    var vault, hex, hexBuffer, privateKey, publicKey, address, balances, wallet;
    return __generator(this, function (_a) {
        try {
            vault = linkvault.replace(vaultUrl, '');
            hex = b58.decodeBase58(vault);
            hexBuffer = Buffer.from(hex, "hex");
